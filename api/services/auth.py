...
class AuthService:
    ...
    def register_user(
        ...
        user = self.db.execute_query(
            """
            INSERT INTO users (school_id, email, phone, password_hash, first_name, last_name, role)
            VALUES (%s, %s, %s, %s, %s, %s, %s)
            RETURNING id, school_id, email, phone, first_name, last_name, role, status, created_at
            """,
            (school_id, email, phone, password_hash, first_name, last_name, role),
            fetch=True
        )[0]
