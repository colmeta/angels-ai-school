      ...
      <div className="px-4 md:px-0 space-y-6">
        ...
        {activeTab === "schedule" && (
          <div className="bg-slate-900 border border-slate-800 rounded-2xl p-8 text-center animate-in fade-in">
            ...
            <h3 className="text-xl font-bold text-white">Full Timetable</h3>
            <p className="text-slate-400 mt-2">View your weekly class schedule here.</p>
            <button className="mt-4 px-6 py-2 bg-slate-800 rounded-full text-sm font-semibold hover:bg-slate-700">
              Download PDF
            </button>
          </div>
        )}
