                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="bg-slate-900 border border-slate-700 rounded-xl p-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            {id: 'professional', name: 'Professional', price: '$2/student', features: ['All Starter +', 'Reports', 'WhatsApp'] },
                            {id: 'enterprise', name: 'Enterprise', price: '$3/student', features: ['All Pro +', 'White Label', 'Priority Support'] },
                            {id: 'pilot', name: 'Pilot (Free)', price: '$0/student', features: ['All Features', 'Pilot Access'], recommended: true }
                            <label
                                key={plan.id}
                                className={clsx(
